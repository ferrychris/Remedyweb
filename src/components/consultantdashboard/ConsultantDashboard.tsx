...
const navigation = [
  ...
  { name: 'Patients', href: '/consultant/patients', icon: Users },
  { name: 'Appointments', href: '/consultant/appointments', icon: Calendar },
  { name: 'Messages', href: '/consultant/messages', icon: MessageSquare },
  { name: 'Settings', href: '/consultant/settings', icon: Settings },
  { name: 'Set Availability', href: '/consultant/set-availability', icon: Calendar },
  { name: 'Appointment Manager', href: '/consultant/appointmentmanager', icon: Calendar },
];
      ...
      <div className={`fixed inset-0 z-40 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex min-h-0 flex-1 flex-col">
            <div className="flex h-16 flex-shrink-0 items-center px-4 bg-emerald-600">
              <h1 className="text-xl font-bold text-white">Consultant Dashboard</h1>
            </div>
